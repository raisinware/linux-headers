...
do
	...
	cp    -rv "include/asm-$arch" "include/asm-generic" "include/linux" "include/net" "include/scsi" "include/video" "include/math-emu" "include/pcmcia" "../.header_tmp/$arch/include"
